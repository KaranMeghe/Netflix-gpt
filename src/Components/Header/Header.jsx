...
const Header = () => {
    const { user, handleSignOut, handleToggleGpt } = useHeaderLogic();
    ...
    return (
        <div className='absolute px-8 py-2 bg-gradient-to-b from-black w-full h-18 flex justify-between z-10'>
            ...
            {!user ? null : <div className='px-8 py-2 flex gap-2 items-center h-16'>
                <Button onClick={handleToggleGpt} className="text-white border rounded-sm border-green-600 bg-green-600 p-1 mx-4">Gpt Search</Button>
